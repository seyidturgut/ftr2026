...
import { ArrowRight, PlayCircle, MousePointer2, Activity } from 'lucide-react';
...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const x = (clientX - window.innerWidth / 2) / 40; // Sensitivity
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen pt-32 pb-20 px-6 flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            {/* Primary Button */}
            <button className="group relative px-8 py-4 rounded-xl font-semibold text-white overflow-hidden shadow-xl shadow-sky-500/20 transition-all hover:scale-[1.02]">
            ...
            {/* Secondary Button */}
            <button className="px-8 py-4 rounded-xl font-medium text-slate-700 dark:text-white border border-slate-300 dark:border-white/10 bg-white/60 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 backdrop-blur-md transition-all flex items-center gap-2 hover:border-slate-400 dark:hover:border-white/20">
        ...
        >
          ...
          >
             ...
             {/* Floating Elements popping out of card */}
      ...
      >
        <span className="text-xs tracking-widest text-slate-500 uppercase">Kaydır</span>
