...
const features = [
  {
    ...
    color: "blue", // Base color key for dynamic styling
    iconBg: "bg-blue-500",
  ...
  return (
    <section className="relative py-32 w-full overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* 1. Header Section - Scroll Storytelling */}
        <motion.div 
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl mx-auto"
          >
        ...
        >
          {features.map((feature, index) => {
            // Determine dynamic colors based on feature type
            let bgHoverClass = "";
            let textHoverClass = "";
