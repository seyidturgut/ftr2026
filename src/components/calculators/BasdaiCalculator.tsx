                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            <Activity className="text-rose-600 dark:text-rose-500" size={24} />
                            BASDAI Hesaplayıcı
                        </h1>
                        <p className="text-sm text-gray-500 dark:text-slate-400 hidden sm:block">Bath Ankylosing Spondylitis Disease Activity Index</p>
                    </div>
                </div>
                    ...
                    <div className="bg-blue-50/50 dark:bg-blue-900/10 p-5 rounded-2xl border border-blue-100 dark:border-blue-900/30 text-xs text-blue-900 dark:text-blue-100 leading-relaxed">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center p-2 bg-white/50 dark:bg-slate-900/50 rounded-lg">
                                <span>&lt; 4</span>
                                <span className="font-bold text-emerald-600 dark:text-emerald-400">Düşük Aktivite</span>
                            </div>
                            <div className="flex justify-between items-center p-2 bg-white/50 dark:bg-slate-900/50 rounded-lg">
                                <span>&ge; 4</span>
                                <span className="font-bold text-rose-600 dark:text-rose-400">Yüksek Aktivite</span>
                            </div>
                        </div>
                    </div>
                </div>
